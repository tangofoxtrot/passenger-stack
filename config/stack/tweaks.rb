package :server_tweaks do
  ...
  push_text 'export PS1="\[\e[32;1m\]\u\[\e[0m\]\[\e[32m\]@\h\[\e[36m\]\w \[\e[33m\]\$ \[\e[0m\]"', '~/.bash_profile',  {:sudo => true} do
    post :install, "echo 'hiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii'"
    # post :install, 'sudo perl -pi -e \'s/(PermitRootLogin)\s+yes$/\1 no/g\' /etc/ssh/sshd_config'
    post :install, "sudo perl -p -i.old -e 's/PermitRootLogin no/PermitRootLogin yes/g' /etc/ssh/sshd_config"
