# Require our stack
%w(essential apache scm ruby_enterprise memcached mysql image_libraries firewall image tweaks misc munin).each do |r|
...
policy :passenger_stack, :roles => :app do
  ...
  requires :monitoring       # Server monitoring such as Munin  
